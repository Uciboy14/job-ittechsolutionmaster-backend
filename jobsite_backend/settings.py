"""
Django settings for jobsite_backend project.
...
SECRET_KEY = 'django-insecure-eg+9qp77v6$r&v9v4pt6pbg392^f0xn^e4-$0lu_s26&)l%uqv'
...
ROOT_URLCONF = 'jobsite_backend.urls'
...
WSGI_APPLICATION = 'jobsite_backend.wsgi.application'
